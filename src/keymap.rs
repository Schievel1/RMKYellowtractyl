...
use rmk::{a, k, layer, mo, mt, wm, shifted};
...
[a!(No), a!(No),           k!(LeftBracket), k!(RightBracket), mt!(Macro0, LSHIFT), k!(Space), a!(No), mt!(Macro1, RSHIFT), k!(PageUp), k!(PageDown), a!(No), a!(No)],
