use rmk::channel::{send_controller_event, ControllerPub, ControllerSub, CONTROLLER_CHANNEL};
            ...
            match new_layer {
                0 => {
                    send_controller_event(
                        &mut self.publ,
                        ControllerEvent::PointingContEvent((0, PointingSetCpi(1600))),
                    );
                }
                1 => {
                    send_controller_event(
                        &mut self.publ,
                        ControllerEvent::PointingContEvent((0, PointingSetCpi(200))),
                    );
                }
                _ => {}
            }
...
pub async fn debug_pointing_device_events(mut publ: ControllerPub) {
    loop {
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSetCpi(800))),
        );
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSetPollIntervall(4000))),
        );
        Timer::after_secs(1).await;
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSetRotTransAngle(-15))),
        );
        Timer::after_secs(1).await;
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointigSetLiftoffDist(8))),
        );
        Timer::after_secs(1).await;
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSetForceAwake(true))),
        );
        Timer::after_secs(1).await;
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSetInvertX(true))),
        );
        Timer::after_secs(1).await;
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSetInvertY(false))),
        );
        Timer::after_secs(1).await;
        ...
        send_controller_event(
            &mut publ,
            ControllerEvent::PointingContEvent((0, PointingEvent::PointingSwapXY(false))),
        );
        Timer::after_secs(1).await;
    }
}
